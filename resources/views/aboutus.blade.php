    ...
    <div class="container">
        <div class="row align-items-center g-5">
            <div class="col-lg-6 " data-aos="fade-right">
                <img src="{{ asset('assets/img/2.jpg') }}" alt="Restoran Interior" class="img-fluid m-auto rounded-4 shadow-lg" style="height:750px;">
            </div>
            <div class="col-lg-6" data-aos="fade-left">
            <div class="p-4 rounded-4 shadow-lg h-100 text-center" style="background:rgba(255,255,255,0.1); color:#efefef">
                <h2 class="fw-bold mb-3" style="color:#efefef;">Restoran Kami</h2>
        ...
        <div class="row align-items-center g-5">
            <div class="col-lg-6" data-aos="fade-left">
            <div class="p-4 rounded-4 shadow-lg h-100 text-center" style="background:rgba(255,255,255,0.1); color:#efefef">
                <h2 class="fw-bold mb-3" style="color:#efefef;">Menu Favorit Kami</h2>
            ...
            <div class="col-lg-6" data-aos="fade-right">
                <img src="{{ asset('assets/img/8.jpg') }}" alt="Menu Favorit" class="img-fluid m-auto rounded-4 shadow-lg" style="height:750px;">
            </div>
        </div>
            ...
            <div class="col-lg-6" data-aos="fade-left">
                <div class="p-4 rounded-4 shadow-lg h-100 text-center" style="background:rgba(255,255,255,0.1); color:#efefef">
                    <ul class="list-unstyled fs-5 text-center">
                        <li>enyajikan makanan berkualitas tinggi dengan bahan segar.</li>
